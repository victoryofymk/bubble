package com.it.ymk.bubble.core.interceptor;
 ...
 *  模糊查询拦截器，过滤通配符
 * 使用方法：
 * <bean id="searchInterceptor" class="com.***.springframework.web.interceptor.SearchInterceptor" >
 * </bean>
 ...
 * @author Yanmingkun
 * @version $v:1.0, $time:2017-04-17, $id:SearchInterceptor.java, Exp $
 */
