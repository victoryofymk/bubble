...
public class NoiseLine {
    ...
    public NoiseLine() {
        ...
        int y = 0;
        try {
            final BufferedImage img = ImageIO.read(new File("/opt/ymk/product/webbas/3.png"));
            this.renderImg = img;
    ...
    public void saveImg() {
        try {
            ImageIO.write(this.renderImg, "JPG", new File("/opt/ymk/product/webbas/noiseRender.png"));
        } catch (final IOException e) {
            e.printStackTrace();
        }
    }
