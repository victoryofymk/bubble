package com.it.ymk.bubble.springboot.web.web.taobao;
...
public class TmallCrawler {
    ...
    public static String getLoginCookie(String name, String pd) {
        ...
        try {
            ...
            webDriver.get(
                "https://login.com.com.it.ymk.bubble.springboot.web.web.taobao.com/member/login.jhtml?qrLogin=false");
            // 输入用户名
    ...
    public static List<Shop> getShops(String cookieStr) throws Exception {
        ...
        String collection = "https://shoucang.com.com.it.ymk.bubble.springboot.web.web.taobao.com/shop_collect_n.htm?type=0&tab=0&ifAllTag=0";
    ...
    public static void main(String[] args) throws Exception {
        String str = getRedirectUrl(
            "//store.com.com.it.ymk.bubble.springboot.web.web.taobao.com/?shop_id=254566010&scm=");
