...
define(function (require, exports, module) {
        ...
        module.exports = {
            init: function () {
                var _this = this;
                _this.bindEditUrlBtn();

            },
            bindEditUrlBtn: function () {
             ...
             * fade 和slide time:
             */
            toastr: function (title, icon, msg, type, time) {
             ...
             * @returns {*}
             */
            forTimeByPattern: function (timeStr, pattern) {
                if (value) {
             ...
             * @param top 到上面的距离
             */
            easyuiPanelOnMove: function (left, top) {
